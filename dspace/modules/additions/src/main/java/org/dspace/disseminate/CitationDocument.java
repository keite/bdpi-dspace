...
public class CitationDocument {
	...
	/**
	 * 130618 - Dan Shinkai - Variavel que recupera a URL do Dspace
	 */
	private static String dspaceURL = null;
    ...
    private static boolean isCitationEnabledGlobally() {
        if(citationEnabledGlobally == null) {
            citationEnabledGlobally = ConfigurationManager.getBooleanProperty("disseminate-citation", "enable_globally", true);
        }
    ...
    private void generateCoverPage(Document cDoc, PdfWriter writer, CitationMeta cMeta) throws DocumentException, MalformedURLException, IOException{
        ...
        Paragraph license = new Paragraph("Downloaded from: " + dspaceName + ", Universidade de São Paulo", helv12_italic);
