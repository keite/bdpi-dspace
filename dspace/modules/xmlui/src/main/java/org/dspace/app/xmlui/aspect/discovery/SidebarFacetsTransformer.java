                    ...
                    if (facetValues != null && 0 < facetValues.size()) {
                        ...
                        for (int i = 0; i < shownFacets; i++) {
                            ...
                            if (i < shownFacets - 1) {
								...
								/** 130809 - Dan Shinkai - Codigo inserido para traduzir os metadados cadastrados no discovery-sidebar.cfg. **/
									String displayProperty = ConfigurationManager.getProperty("discovery-sidebar", displayedValue.trim());
                                    
									if(displayProperty != null) {
                                    	filterValsList.addItem().addXrefConcatMessage(
                                            contextPath +
                                            ...
                                            message(displayProperty), " (" + value.getCount() + ")"											
										);
                                    } else {
