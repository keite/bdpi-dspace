...
public abstract class RichTextContainer extends TextContainer
{
	...
	/** 130425 - Dan - Metodo criado para retirar links contidos nas fotos ou graficos */
    public Figure addFigureSemLink(String source, String rend)
            throws WingException
    {
        Figure figure = new Figure(context, source, rend);
        contents.add(figure);
        return figure;
    }
