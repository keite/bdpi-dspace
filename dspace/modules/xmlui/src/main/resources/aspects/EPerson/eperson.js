...
{ 
    ...
    if (token == null) 
    {
        ...
        do {
            ...
            if (canRegister) 
            {
                ...
                cocoon.sendPage("oauthregister/verify", { "email":email, "forgot":"false" });
                return; 
            } 
            else 
            {
                cocoon.sendPage("oauthregister/cannot", { "email" : email});
                return;
            }
    ...
    else 
    {
        ...
        if (email == null) 
        {
            cocoon.sendPage("oauthregister/invalid-token");
            return;
        }
        ...
        var errors = new Array();
        do {
            cocoon.sendPageAndWait("oauthregister/profile",{"email" : email, "allowSetPassword":setPassword , "errors" : errors.join(',')});
        ...
        cocoon.sendPage("oauthregister/finished");
        return;
    }
}
