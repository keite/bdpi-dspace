...
// set other globals
var api_key='GREEK_YOGURT'
var segmentio_key = 'na1r5jvuym'
var mixpanelKey = 'dbd67a8422ad071e22915d6218cf1dc2'
...
function ItemController($){
    ...
    *********************************/
    jQuery(document).ready(function ($) {
        ...
        var badgesTemplateStr = '<ul class="ti-badges">   {{#big}}   <li><span href="#"             class="label ti-badge big-badge {{audience}} {{engagementType}}"             rel="tooltip"             title="Highly {{engagementType}} by <span class=&apos;audience {{audience}}&apos;>{{displayAudience}}</span>"             data-content="This item has {{topMetric.actualCount}} {{topMetric.environment}}             {{topMetric.displayInteraction}}. That&apos;s better than             {{topMetric.percentiles.CI95_lower}}% of items             {{topMetric.referenceSetStorageVerb}} {{topMetric.refSet}} in {{topMetric.referenceSetYear}},             suggesting it&apos;s highly {{engagementType}} by {{ displayAudience }}.             Click to learn more."           >         <span class="modifier">highly</span>         <span class="engagement-type">{{engagementType}}</span>         <span class="audience">by {{audience}}</span>      </span></li>   {{/big}}   {{#any}}   <li><span href="#"             class="label ti-badge lil-badge {{audience}} {{engagementType}}"             rel="tooltip"             title="{{engagementType}} by <span class=&apos;audience {{audience}}&apos;>{{displayAudience}}</span>"             data-content="This item has {{topMetric.actualCount}} {{topMetric.environment}}             {{topMetric.displayInteraction}}, suggesting it&apos;s been             {{engagementType}} by {{displayAudience}}.             Click to learn more."           >         <span class="engagement-type">{{engagementType}}</span>         <span class="audience">by {{audience}}</span>      </span></li>   {{/any}}</ul>'
