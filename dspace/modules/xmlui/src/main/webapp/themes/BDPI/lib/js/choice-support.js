...
//
//thanks for removeDiacritics function taken from Backbone.js Backbone Paginator plugin
//https://raw.github.com/backbone-paginator/backbone.paginator/master/plugins/diacritic.js
//
...
function DSpaceChoicesLoad(form) {
	...
	*/
    ...
    $.ajax({
        ...
        type: "GET",
        data: {query: removeDiacritics(value), collection: collID,
