...
<!-- 130403 andre.assada@usp.br URI, ID origem e DOI by Dan Shinkai -->
                <xsl:choose>
                   ...
                   <xsl:when test="@qualifier='id' and @element='origem'">
                      <a>
                         <xsl:attribute name="href">
                            <xsl:value-of select="current()"/>
                         </xsl:attribute>
                    ...
                    <!-- cria um link para metadados do tipo DOI -->
                    <xsl:when test="@qualifier='doi'">
                       <xsl:variable name="primeiroIndex" select="substring(current(),1,1)" />
                       <xsl:variable name="stringLength" select="string-length(current())" />
                       <xsl:choose>
                          <xsl:when test="$primeiroIndex = '1' and $stringLength > 10" >
                             <a>
                                <xsl:attribute name="href">
...
<!-- FIM 120403 andre.assada@usp.br URI, ID origem e DOI by Dan Shinkai FIM -->
<!--120403 andre.assada@usp.br URI, ID origem e DOI by Dan Shinkai        <xsl:copy-of select="./node()"/> -->
